    ...
    <aside className="fixed left-0 top-0 h-full w-60 bg-green-900 text-white flex flex-col z-40">
      ...
      <div className="px-3 py-4 border-t border-green-800">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-sm font-medium text-green-200 hover:bg-green-800 hover:text-white transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
